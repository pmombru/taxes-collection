...
-- Started on 2019-09-09 17:30:01
...
--
-- TOC entry 2944 (class 1262 OID 16867)
...
--
-- TOC entry 229 (class 1255 OID 17615)
...
BEGIN
	...
	ELSE
		IF(comencement_date > CURRENT_TIMESTAMP) THEN
			RAISE 'The comencement date cannot be after current date';
		ELSE
...
--
-- TOC entry 228 (class 1255 OID 17602)
...
BEGIN
	...
	IF(amount < 0) THEN
		RAISE 'The amount cannot be a negative value';
	ELSE
		IF(payment_date > CURRENT_TIMESTAMP) THEN
			RAISE 'The payment date cannot be after current date';
		ELSE
...
--
-- TOC entry 2753 (class 2604 OID 17497)
...
--
-- TOC entry 2754 (class 2604 OID 17510)
...
--
-- TOC entry 2752 (class 2604 OID 17486)
...
--
-- TOC entry 2751 (class 2604 OID 17455)
...
--
-- TOC entry 2755 (class 2604 OID 17521)
...
--
-- TOC entry 2756 (class 2604 OID 17532)
...
--
-- TOC entry 2750 (class 2604 OID 17444)
...
--
-- TOC entry 2932 (class 0 OID 17494)
-- Dependencies: 207
...
--
-- TOC entry 2934 (class 0 OID 17507)
-- Dependencies: 209
...
--
-- TOC entry 2928 (class 0 OID 17471)
-- Dependencies: 203
...
--
-- TOC entry 2927 (class 0 OID 17463)
-- Dependencies: 202
...
--
-- TOC entry 2930 (class 0 OID 17483)
-- Dependencies: 205
...
--
-- TOC entry 2926 (class 0 OID 17452)
-- Dependencies: 201
...
--
-- TOC entry 2936 (class 0 OID 17518)
-- Dependencies: 211
...
--
-- TOC entry 2938 (class 0 OID 17529)
-- Dependencies: 213
...
--
-- TOC entry 2922 (class 0 OID 17430)
-- Dependencies: 197
-- Data for Name: taxpayer; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.taxpayer (taxpayer_id, type, email, created_at, created_by, last_upd_by) VALUES (1, 'I', 'taxpayer1@gmail.com', '2019-09-09 14:58:37.372677', 'postgres', 'postgres');
...
--
-- TOC entry 2924 (class 0 OID 17441)
-- Dependencies: 199
...
SELECT pg_catalog.setval('public.tax_payment_payment_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.taxpayer_taxpayer_id_seq', 15, true);


--
-- TOC entry 2776 (class 2606 OID 17504)
...
--
-- TOC entry 2780 (class 2606 OID 17515)
...
--
-- TOC entry 2778 (class 2606 OID 17502)
...
--
-- TOC entry 2769 (class 2606 OID 17480)
...
--
-- TOC entry 2771 (class 2606 OID 17478)
...
--
-- TOC entry 2767 (class 2606 OID 17470)
...
--
-- TOC entry 2773 (class 2606 OID 17491)
...
--
-- TOC entry 2763 (class 2606 OID 17460)
...
--
-- TOC entry 2765 (class 2606 OID 17462)
...
--
-- TOC entry 2783 (class 2606 OID 17526)
...
--
-- TOC entry 2786 (class 2606 OID 17537)
...
--
-- TOC entry 2788 (class 2606 OID 17539)
...
--
-- TOC entry 2760 (class 2606 OID 17449)
...
--
-- TOC entry 2758 (class 2606 OID 17438)
...
--
-- TOC entry 2781 (class 1259 OID 17597)
...
--
-- TOC entry 2774 (class 1259 OID 17596)
...
--
-- TOC entry 2784 (class 1259 OID 17598)
...
--
-- TOC entry 2761 (class 1259 OID 17595)
...
--
-- TOC entry 2795 (class 2606 OID 17570)
...
--
-- TOC entry 2796 (class 2606 OID 17575)
...
--
-- TOC entry 2792 (class 2606 OID 17555)
...
--
-- TOC entry 2791 (class 2606 OID 17550)
...
--
-- TOC entry 2794 (class 2606 OID 17565)
...
--
-- TOC entry 2793 (class 2606 OID 17560)
...
--
-- TOC entry 2797 (class 2606 OID 17580)
...
--
-- TOC entry 2799 (class 2606 OID 17590)
...
--
-- TOC entry 2798 (class 2606 OID 17585)
...
--
-- TOC entry 2790 (class 2606 OID 17545)
...
--
-- TOC entry 2789 (class 2606 OID 17540)
...
-- Completed on 2019-09-09 17:30:02
